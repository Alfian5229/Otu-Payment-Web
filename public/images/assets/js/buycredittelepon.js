app.controller('buycreditteleponCtrl', function($scope, $http) {
    ...
    if(isAllLoad == false){
        ...
        $.post("../buycredittelepon/getjsonprefixtelpon", function(data){
            prefix = data;
        });
        //get data json for telepon
        $.post("../buycredittelepon/getjsonTelepon", function(data){
            hasildata = data;
        });
        isAllLoad = true;
    }
    ...
    $scope.tampilModalAlert = function(){
        $.post("../buycredittelepon/buytelepon", { kodeitem: kodeItem, nomerhp: $scope.myValue} ,function(data){
    ...
    // function for check data telepon with api
    function getDataTelepon(providertelepon){
        $.post("../buycredittelepon/getdatatelepon", { providertelepon: providertelepon} ,function(data){
